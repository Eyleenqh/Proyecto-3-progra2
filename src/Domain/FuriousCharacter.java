...
public class FuriousCharacter extends Character {
    ...
    public void setDownSprite() throws FileNotFoundException {
        ...
        sprite.clear();
        for (int i = 0; i < 3; i++) {
            sprite.add(new Image(new FileInputStream("assets/paDa" + (i + 1) + ".png")));
        }
        super.setSprite(sprite);
    }
    ...
    public void setUpSprite() throws FileNotFoundException {
        ...
        sprite.clear();
        for (int i = 0; i < 3; i++) {
            sprite.add(new Image(new FileInputStream("assets/paU" + (i + 1) + ".png")));
        }
        super.setSprite(sprite);
    }
    ...
    public void setLeftSprite() throws FileNotFoundException {
        ...
        sprite.clear();
        for (int i = 0; i < 3; i++) {
            sprite.add(new Image(new FileInputStream("assets/paI" + (i + 1) + ".png")));
        }
        super.setSprite(sprite);
    }

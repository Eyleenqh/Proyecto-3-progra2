...
//define los sprite
    ...
    public void setRightSprite() throws FileNotFoundException {
        ...
        sprite.clear();
        for (int i = 0; i < 3; i++) {
            sprite.add(new Image(new FileInputStream("assets/sD" + (i + 1) + ".png")));
        }
    ...
    public void setDownSprite() throws FileNotFoundException {
        ...
        sprite.clear();
        for (int i = 0; i < 3; i++) {
            sprite.add(new Image(new FileInputStream("assets/sDo" + (i + 1) + ".png")));
        }
        super.setSprite(sprite);
    }
    ...
    public void setUpSprite() throws FileNotFoundException {
        ...
        sprite.clear();
        for (int i = 0; i < 3; i++) {
            sprite.add(new Image(new FileInputStream("assets/sU" + (i + 1) + ".png")));
        }
        super.setSprite(sprite);
    }
    ...
    public void setLeftSprite() throws FileNotFoundException {
        ...
        sprite.clear();
        for (int i = 0; i < 3; i++) {
            sprite.add(new Image(new FileInputStream("assets/sI" + (i + 1) + ".png")));
        }
        super.setSprite(sprite);
    }
